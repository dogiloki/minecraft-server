...
public class Instancia extends javax.swing.JDialog {

    public Instancia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btn_okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_okActionPerformed
        ...
        String folder="instances/"+nombre;
        if(nombre.equals("")){
        ...
        Storage.createFolder(folder+"/server");
        Storage.writeFile(lineas,folder+"/instance.cfg");
        dispose();
    }//GEN-LAST:event_btn_okActionPerformed
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Instancia dialog = new Instancia(new javax.swing.JFrame(), true);
