...
public class Instance extends javax.swing.JDialog{
    
    private Config config_global;
    private GsonManager versions;

    public Instance(java.awt.Frame parent, boolean modal, Config config_global) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Instance dialog = new Instance(new javax.swing.JFrame(), true, null);
